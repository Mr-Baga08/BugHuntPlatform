...
import TaskExcelUploader from "./assets/Componets/Admin Dashboard/TaskExcelUploader";
import Leaderboard from "./assets/Componets/Leaderboard/Leaderboard";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/hunter-leaderboard" element={
          <Protected>
            <Leaderboard role="hunter" />
          </Protected>
        } />
        
        <Route path="/coach-leaderboard" element={
          <Protected>
            <Leaderboard role="coach" />
          </Protected>
        } />

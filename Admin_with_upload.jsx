...
import { Check, X, Home, FileSpreadsheet, Trophy } from "lucide-react";
    ...
    <div className={isDarkMode ? "dark" : ""}>
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        ...
        <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 transition-colors duration-300 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden transition-colors duration-300">
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4 transition-colors duration-300">
                  Upload multiple tasks at once using an Excel spreadsheet.
                </p>
                <button
                  onClick={() => navigate("/bulk-upload")}
                  className="w-full bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded transition-colors duration-150"
                >
                  Upload Excel
                </button>
              </div>
          ...
          {/* Leaderboard Cards */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            {/* Hunters Leaderboard Card */}
            <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg shadow-md overflow-hidden">
              <div className="p-6 text-white">
                ...
                <p className="mb-4 text-green-100">
                  View top-performing bug hunters ranked by completed tasks.
                </p>
                <button
                  onClick={() => navigate("/hunter-leaderboard")}
                  className="w-full bg-white text-green-600 font-medium py-2 px-4 rounded transition-colors duration-150 hover:bg-green-50"
                >
                  View Rankings
                </button>
              </div>
            ...
            <div className="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg shadow-md overflow-hidden">
              <div className="p-6 text-white">
                ...
                <p className="mb-4 text-blue-100">
                  Track the most active and successful team coaches.
                </p>
                <button
                  onClick={() => navigate("/coach-leaderboard")}
                  className="w-full bg-white text-blue-600 font-medium py-2 px-4 rounded transition-colors duration-150 hover:bg-blue-50"
                >
                  View Rankings
                </button>
              </div>
            ...
            <div className="bg-gradient-to-r from-purple-500 to-pink-600 rounded-lg shadow-md overflow-hidden">
              <div className="p-6 text-white">
                <div className="flex items-center mb-3">
                  <Trophy className="h-6 w-6 text-yellow-300 mr-2" />
                  <h3 className="text-lg font-medium">
                ...
                <p className="mb-4 text-purple-100">
                  See all team members ranked by their overall performance.
                </p>
                <button
                  onClick={() => navigate("/leaderboard")}
                  className="w-full bg-white text-purple-600 font-medium py-2 px-4 rounded transition-colors duration-150 hover:bg-purple-50"
                >
                  View Rankings
                </button>
              </div>
